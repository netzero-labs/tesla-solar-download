...
**Tesla seems to be removing Owner API access, so this project will be archived on Aug 1, 2026. As an alternative, use the [Netzero app](https://www.netzero.energy) app to download data.**
